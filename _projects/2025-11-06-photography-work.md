...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
  ...
  <figure>
    <img src="{{ site.baseurl }}/images/Church_is_Anywhere.jpg" alt="Church is Anywhere" style="width:100%; border-radius:8px;">
  ...
  <figure>
    <img src="{{ site.baseurl }}/images/Kilmainham_Gaol.jpg" alt="Kilmainham Gaol" style="width:100%; border-radius:8px;">
  ...
  <figure>
    <img src="{{ site.baseurl }}/images/Retro_Ride.png" alt="Retro Ride" style="width:100%; border-radius:8px;">
  ...
  <figure>
    <img src="{{ site.baseurl }}/images/Rock_of_Cashel.jpg" alt="Rock of Cashel" style="width:100%; border-radius:8px;">
  ...
  <figure>
    <img src="{{ site.baseurl }}/images/Scorpion_and_the_Grasshopper.jpg" alt="Scorpion and the Grasshopper" style="width:100%; border-radius:8px;">
  ...
  <figure>
    <img src="{{ site.baseurl }}/images/Jellyfish.jpg" alt="Jellyfish" style="width:100%; border-radius:8px;">
